...
description: "Una ronda de financiación participativa que conecta el trabajo regenerativo local con la infraestructura Web3 global"
---
...
En lugar de imponer soluciones blockchain externas, **construimos dentro de ecosistemas de confianza**, empoderando proyectos ejemplares para generar historias de éxito visibles que inspiran la adopción más amplia de mecanismos de finanzas regenerativas. Cada proyecto recibe financiación además de formación en herramientas Web3, creando infraestructura continua para la regeneración bioregional.

## Cronograma

**Lanzamiento:** Última semana de octubre de 2025, seguido de formación integral y medición de impacto mediante metodologías probadas adaptadas de la exitosa ronda GG23 de Regen Coordination.
...
Esto no es solo sobre financiar proyectos — se trata de **construir la infraestructura para la regeneración bioregional continua** mientras creamos productos de conocimiento de código abierto que se pueden adaptar globalmente. La combinación de valores cooperativos tradicionales con herramientas Web3 de vanguardia posiciona Regenerant Catalunya como un **puente entre mundos**, probando que la tecnología blockchain puede servir necesidades comunitarias reales en lugar de la especulación.

---

## Una Ronda de Financiación Participativa para la Regeneración en Cataluña

_Ronda de Financiación Participativa Bioregional en Cataluña_

**Regenerant Catalunya** es una ronda de financiación participativa dedicada a canalizar recursos hacia proyectos que están regenerando la vida en la bioregión catalana. Desde conservar y restaurar ecosistemas naturales como la cuenca del río Fluvià hasta desarrollar infraestructuras comunitarias en L'Hospitalet de Llobregat — el segundo municipio más poblado de Cataluña y una de las ciudades más densamente pobladas de Europa — esta iniciativa pretende **apoyar el trabajo regenerativo sobre el terreno** por toda la región.
...
_Si eres un financiador o socio técnico interesado en apoyar la regeneración de la bioregión catalana, te invitamos a **ponerte en contacto** para explorar cómo puedes contribuir al fondo de igualación o apoyar las actividades educativas y técnicas. Esta ronda es solo el comienzo — la primera de muchas iniciativas para empoderar la regeneración bioregional en Cataluña — y esperamos colaborar con todos los que estén alineados en este viaje a largo plazo._
...
Guía completa para proyectos participantes que cubre los requisitos de la Fase 1, configuración de Karma, guía de cartera y horario de talleres.
...
Enlaces a todas las guías, documentación de herramientas, materiales de talleres y canales de apoyo.
