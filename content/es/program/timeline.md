...
```mermaid
gantt
    title Regenerant Catalunya GG24 - Cronograma del Programa
    dateFormat  YYYY-MM-DD
    section Preparación
    Fondos Locales Asegurados          :done, prep1, 2025-10-31, 1d
    Fondos de Igualación Globales         :active, prep2, 2025-11-15, 1d
    section Fase 1
    Taller #1                   :workshop1, 2025-11-17, 5d
    Horas de Oficina                  :office, 2025-12-04, 16d
    Taller #2                   :workshop2, 2025-12-08, 7d
    Desembolso Fase 1          :disburse1, 2025-12-31, 1d
    section Fase 2
    Taller #4                   :workshop4, 2026-01-15, 1d
    Taller #5                   :workshop5, 2026-01-31, 30d
    Activación Gobernanza Red :governance, 2026-02-28, 1d
    section Finalización
    Informe Final                  :report, 2026-03-15, 15d
```
...
```mermaid
graph LR
    A[Incorporación de Proyectos<br/>Nov 2025] --> B[Fase 1: Base<br/>Nov-Dic 2025]
    B --> C[Informes Karma<br/>+ Evaluación Simplificada de Impacto]
    C --> D[Desembolso<br/>Mín €1.000, hasta €1.500/proyecto]
    D --> E[Fase 2: Gobernanza Red<br/>Ene-Feb 2026]
    E --> F[Herramientas a Nivel de Red<br/>Gardens, Safe, Sarafu, Cycles]
    F --> G[Activación Fondo Colectivo<br/>Miceli ~€6k, La Fundició ~€5k]
    G --> H[Informe Final<br/>Feb-Mar 2026]
