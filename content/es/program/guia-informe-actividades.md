...
> Si solo quieres rellenar la plantilla en Google Docs, puedes pasar directamente a la sección **“2. Informe de Actividades – Guía”**.  
> Con entender **actividades, entregables y métricas** es suficiente para usar el documento.
...
> 
> 
> *los cambios (outputs, outcomes) que se producen en la organización (dentro y/o a través de sus programas) y con sus grupos de interés (incluyendo usuarias, clientela, aliadas, etc.) a lo largo del tiempo (corto y largo plazo) como resultado de las actividades de la organización.» (Fuente: [Innoweave](https://innoweave.ca/streams/impact-measurement/))*
> 
...
- **Nombre del entregable:** cómo lo llamáis
...
- **Enlace / prueba (si existe):** hoja de asistencia, tabla, informe, etc.
...
### 2.1 Parte superior del documento
...
## A. Más adelante: llevar esto a Karma GAP
...
- **Plantilla en Google Docs del Informe de actividades:**
    ...
    (enlace que compartirá el equipo de coordinación a cada proyecto)
    
</aside>

Si tienes dudas sobre cómo rellenar el informe o qué actividades elegir, puedes preguntarlo directamente en tu taller o escribir a **hola@refibcn.cat**.