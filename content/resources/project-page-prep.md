...
3. If you don't have access, contact hola@ReFiBCN.cat

**Support:** Contact hola@ReFiBCN.cat if you need help accessing or using the Google Doc
...
- **Q: What if I can't access the Google Doc?**
  - A: Contact hola@ReFiBCN.cat immediately. We'll help you get access.
