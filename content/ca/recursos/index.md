...
description: "Enllaços a totes les guies, documentació d'eines, materials de tallers i canals de suport"
---

# Regenerant Catalunya - Recursos del Programa

Centre central per a tots els recursos, documentació i materials de suport per als participants de Regenerant Catalunya.
...
- **[Guia per a l'informe d'activitats](/ca/recursos/guia-informe-actividades)** — Guia completa per documentar activitats, lliurables i mètriques utilitzant la plantilla de Google Docs
- **[Guia de Karma GAP](/ca/recursos/guia-karma-gap)** — Guia pas a pas per publicar activitats a la plataforma Karma GAP
...
- **Guia:** [Guia completa de Karma GAP](/ca/recursos/guia-karma-gap)
...
- **Casos d'ús:** Plantilla per a projectes i voluntaris, recompenses i premis
...
- **Casos d'ús:** Gestió de tresoreria de xarxa, desemborsaments de fons transparents
- **Formació:** Cobrit al Taller #4 (gener 2026)
...
- **Casos d'ús:** Sistemes de moneda local, agrupació de compromisos per a projectes col·lectius
- **Formació:** Cobrit al Taller #4 (gener 2026)
...
- **Casos d'ús:** Fluxos d'economia circular, sistemes de crèdit mutu
- **Formació:** Cobrit al Taller #4 (gener 2026)
...
- **Silvi** — Plantació d'arbres i gestió dMRV
- **Hypercerts/Ecocerts** — Credencials d'impacte
- **Gainforest** — MRV forestal
- **Kokonut Network** — Disseny d'agroforestació sintròpica
...
- **[Guia per a l'informe d'activitats](/ca/recursos/guia-informe-actividades)** — Guia completa per documentar activitats
...
- **[Guia de Karma GAP](/ca/recursos/guia-karma-gap)** — Guia pas a pas per publicar activitats
...
- **Adreça Safe Multisig:** 0x91889ea97FeD05180fb5A70cB9570630f3C0Be77 (a Celo)
- **Transparència:** Tots els desemborsaments documentats públicament mitjançant registres en cadena + actualitzacions de Karma
...
- [Discussió de Karma GAP](https://discuss.octant.app/t/karma-gap-grantee-accountability-and-reputation-protocol/232)
- [Retrospectiva de Regen Coordination GG23](https://gov.gitcoin.co/t/ai-impactqf-regen-coordination-global-gg23-retrospective/20385)
...
- [Inici](/ca/)
- [Sobre el Programa](/ca/programa)
- [Partners i Projectes](/ca/programa/partners-projects)

---

**Necessites ajuda?** No dubtis a contactar-nos a hola@ReFiBCN.cat
