...
**Abans de començar:** Assegura't d'haver completat el teu **[informe d'activitats a Google Docs](/ca/recursos/guia-informe-actividades)**. Aquesta guia t'ajudarà a transferir aquesta informació a Karma GAP.
...
- **Grup de WhatsApp:** https://chat.whatsapp.com/LB9pK2swHYN6oTdX1erjbB

---

## 9. Recursos Relacionats

- **[Guia per a l'informe d'activitats](/ca/recursos/guia-informe-actividades)** — Preparar la informació abans de publicar a Karma GAP
- **[Guia del Projecte](/ca/programa/project-guidebook)** — Guia completa del programa Regenerant Catalunya
- **[Criteris d'Avaluació](/ca/programa/evaluation-criteria)** — Com s'avaluen els projectes
- **[Plataforma Karma GAP](https://gap.karmahq.xyz/)** — Accés directe a la plataforma
