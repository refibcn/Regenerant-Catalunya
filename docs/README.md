...
```
docs/
├── program/          # Program-specific documentation
├── brand/            # Brand and visual design documentation
├── setup/            # Setup and deployment guides
├── development/      # Development guides and technical docs
├── template/         # Template-related documentation (reference)
