function setupCarousel() {
  ...
  const projects = [
    ...
    { name: "Regeneració.XYZ", summary: "A creative agency crafting new narratives for regeneration through artistic expression.", network: "Miceli Social", image: "/static/projects/regeneracio-xyz.jpg" },
    { name: "Resilience Earth & Simbiosi Fluvial", summary: "Worker cooperative applying blockchain and AI systems to improve environmental data collection for the Fluvià River basin.", network: "Miceli Social", image: "/static/projects/resilience-earth.jpg", url: "https://resilience.earth/" },
    { name: "De Bat a Bat", summary: "Developing a regenerative model of community health that is holistic, participatory, and rooted in nature.", network: "Miceli Social", image: "/static/projects/de-bat-a-bat.jpg", url: "http://www.debatabat.org/" },
    { name: "Chapter#2", summary: "Bringing regenerative storytelling into schools, helping them recover their link with place and co-create artistic figures.", network: "Miceli Social", image: "/static/projects/chapter2.jpg", url: "https://chapter2.cat/" },
